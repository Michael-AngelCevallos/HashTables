...
private:
    ...
    vector<Node> nodes; // THIS IS WHERE THE HASH TABLES BUCKETS WILL BE STORED

    unsigned int tableSize = DEFAULT_SIZE;


    // Hash Key Creation--- Coverts
...
HashTable::HashTable(unsigned int size) {
    ...
    // Set the hash table size to the value passed into the constructor
    this->tableSize = size;
